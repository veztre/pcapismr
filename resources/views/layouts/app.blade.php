...
<script type="text/javascript">
    ...
    $("#OECondition").click(function () { //button name
        ++i;
        $("#OEC").append(
            '<tr><td class="counterCell " style="text-align: right" ></td><td><input class="form-control" type="text" name="enhance[]" value="{{ old('enhance[]') }}"></td><td style="text-align: center"><form action=""><div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="status[]"id="oecRadio1" value="Yes"  @if(old('status[]') == 'Yes') checked @endif><label class="form-check-label" for="oecRadio1"><p class="mt-3 mx-1">Yes</p></label></div><div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="status[]"id="oecRadio2" value="No" @if(old('status[]') == 'No') checked @endif><label class="form-check-label" for="oecRadio2"><p class="mt-3 mx-1">No</p></label></div></form></td><td><textarea class="form-control" type="text" name="action[]"style="overflow:scroll; overflow: hidden visible;" value="{{ old('action[]') }}"></textarea></td></tr>'
        ); //table name
    });
</script>
