                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <p class="p-1 mt-3  text-light" style="background-color:gray; font-size:20px ">
                                                ...
                                                <a href="{{route('pdf4')}}" class="btn btn-lg float-right " ><img src="{{asset('public/images/printpdflogo.png')}}" class="inline" height="40px" width="50px" style="backgorund-color:gray;"> EXPORT PDF</a>
                                            </p>
