            ...
            <div class="">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="container col ml-4 mt-4" style="align-content: center">
                        ...
                        <form id="myForm1" action="/saveData6" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- {{ csrf_field() }} -->
                            <br>
                            ...
                            <div class="container">
                                <div class="row">
                                    <p class="p-1 mt-3  text-light" style="background-color:gray; font-size:20px ">
                                        MODULE 6: OTHERS
                                        <a href="{{route('pdf6')}}" class="btn btn-lg float-right " ><img src="{{asset('public/images/printpdflogo.png')}}" class="inline" height="40px" width="50px" style="backgorund-color:gray;"> EXPORT PDF</a>
                                    </p>
