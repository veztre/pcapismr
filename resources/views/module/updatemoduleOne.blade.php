                        ...
                        <form id="myForm" action="{{ route('moduleOne.update', ['moduleOne' => Auth::user()->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <p class="p-1 mt-3  text-light " style="background-color:gray; font-size:20px ">
                                            ...
                                            <a href="{{route('pdf')}}" class="btn btn-lg float-right " ><img src="{{asset('public/images/printpdflogo.png')}}" class="inline" height="40px" width="50px" style="backgorund-color:gray;"> EXPORT PDF</a>
                                        </p>
                            ...
                            <div class="container">
                                <div class="col mb-3">
                                    ...
                                    <a href="/moduleTwo" class="btn btn-lg border bg-light">Next</a>
