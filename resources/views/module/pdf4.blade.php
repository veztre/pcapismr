    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center">
                @if (!is_null($cpe->month1) && !in_array(strtolower($cpe->month1), ['na', ' ', 'none']))
            ...
            <td style="text-align: center">
                @if (!is_null($cpe->month2) && !in_array(strtolower($cpe->month2), ['na', ' ', 'none']))
            ...
            <td style="text-align: center">
                @if (!is_null($cpe->month3) && !in_array(strtolower($cpe->month3), ['na', ' ', 'none']))
        ...
        @foreach ($total_consumption_of_water as $tow)
            ...
            <tr>
                ...
                <td style="text-align: center">
                    @if (!is_null($tow->month1) && !in_array(strtolower($tow->month1), ['na', ' ', 'none']))
                    ...
                    <td style="text-align: center">
                        @if (!is_null($tow->month2) && !in_array(strtolower($tow->month2), ['na', ' ', 'none']))
                    ...
                    <td style="text-align: center">
                        @if (!is_null($tow->month3) && !in_array(strtolower($tow->month3), ['na', ' ', 'none']))
        ...
        @foreach ($total_cost_of_chemicals_used as $tcocu)
            @if($cpe->id == $tcocu->id)
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        @if (!is_null($tcocu->month1) && !in_array(strtolower($tcocu->month1), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($tcocu->month2) && !in_array(strtolower($tcocu->month2), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($tcocu->month3) && !in_array(strtolower($tcocu->month3), ['na', ' ', 'none']))
        ...
        @foreach ($total_consumption_of_electricity as $tcoe)
            @if($cpe->id == $tcoe->id)
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        @if (!is_null($tcoe->month1) && !in_array(strtolower($tcoe->month1), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($tcoe->month2) && !in_array(strtolower($tcoe->month2), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($tcoe->month3) && !in_array(strtolower($tcoe->month3), ['na', ' ', 'none']))
        ...
        @foreach ($administrative_and_overhead_costs as $aaoc)
            @if($cpe->id == $aaoc->id)
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        @if (!is_null($aaoc->month1) && !in_array(strtolower($aaoc->month1), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($aaoc->month2) && !in_array(strtolower($aaoc->month2), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($aaoc->month3) && !in_array(strtolower($aaoc->month3), ['na', ' ', 'none']))
        ...
        @foreach ($cost_of_operating_in_house_laboratory as $cooihl)
            @if($cpe->id == $cooihl->id)
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        @if (!is_null($cooihl->month1) && !in_array(strtolower($cooihl->month1), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($cooihl->month2) && !in_array(strtolower($cooihl->month2), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($cooihl->month3) && !in_array(strtolower($cooihl->month3), ['na', ' ', 'none']))
        ...
        @foreach ($cost_of_improvement_of_modification as $coiom)
            @if($cpe->id == $coiom->id)
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        @if (!is_null($coiom->month1) && !in_array(strtolower($coiom->month1), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($coiom->month2) && !in_array(strtolower($coiom->month2), ['na', ' ', 'none']))
                        ...
                        <td style="text-align: center">
                            @if (!is_null($coiom->month3) && !in_array(strtolower($coiom->month3), ['na', ' ', 'none']))
